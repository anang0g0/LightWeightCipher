...
どの位置にエラーが入っているかを知っているのは暗号作成者だけである。
...
これを公開鍵に使うためには、エラーを暗号文作成者が作らなければならず、公開鍵にエラーをあらかじめ入れて公開することはできない。

したがってこの方法は、秘密鍵に使うのが適していると思われる。

しかしながら、適当な処理を追加すれば公開鍵方式にも適用できる。
