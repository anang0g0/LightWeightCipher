...
素人だから間違えて当然と考えていれば何も怖くない。

暗号のほうもちょっと調べている。
Raoが必死に反論している。
リードソロモンを使えば安全だとか、一方ではバーストエラー訂正符号を使った暗号の解読法なんかもあったりして、何が正しいのかよくわからない。
ちょっと面白そうだからやってみようと始めたところだ。

作業日記をつければGitHubが研究発表の場所になるのだろうか？

そうすれば素人にも研究活動のプラットフォームが開放されるのでいいことだと思う。
無意味なことに時間をかけなくても指摘されればわかるから。

現状の研究をどう見るか。
研究の定義によるけど、ドクターの取得者が政府から資金を受け取って行っている科学技術の問題解決と定義すれば、現状の学会はそうなのかもしれない。
...
最近では処理の軽い暗号がＲＦＩＤなんかで需要があるらしく、私が昔研究してた暗号方式もいまだに改良版とかが出てきていてまだしつこくやってる人が私以外にもいるのだと感心した。
